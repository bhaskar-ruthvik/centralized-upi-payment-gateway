...
function MerchantLogin() {
  ...
  return (
   ...
   <div className="flex items-center content-center justify-center pb-4">
    <h1 className="text-3xl font-sans font-bold justify-center text-white">🧑‍💼Merchant Login</h1>
    </div>
      ...
      <button type="button" className="bg-orange-500 text-white px-3 py-2 rounded-lg" onClick={async ()=>{const resp = await LoginUser(username, password); if(resp===1){navigate('/merchantdashboard')}}}>Login</button>
      </div>
